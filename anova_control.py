	...
	if check_arg(sys.argv[1:]) is not None :
		try:
			...
			if (o == "r") or (o == "raw") :
				...
				data['job_time_remaining'] = 'unknown'
				data['heater_duty_cycle'] = 'unknown'
				data['motor_duty_cycle'] = 'unknown'
				...
				data['heater_temp'] = 'unknown'
				data['triac_temp'] = 'unknown'
				data['water_temp'] = 'unknown'
				json_data = json.dumps(data)
